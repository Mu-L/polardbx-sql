...
public class SelectDdlPlanId {
    ...
    static {
        ...
        fields[i] = PacketUtil.getField("DDL_PLAN_ID()", Fields.FIELD_TYPE_VAR_STRING);
    ...
    public static boolean response(ServerConnection c, boolean hasMore) {
        ...
        row.add(String.valueOf(LogicalRebalanceHandler.getNextPlanId()).getBytes());
