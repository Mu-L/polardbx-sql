...
public class SelectDdlJobId {
    ...
    static {
        ...
        fields[i] = PacketUtil.getField("DDL_JOB_ID()", Fields.FIELD_TYPE_VAR_STRING);
    ...
    public static boolean response(ServerConnection c, boolean hasMore) {
        ...
        row.add(String.valueOf(DdlJobManager.ID_GENERATOR.nextId()).getBytes());
