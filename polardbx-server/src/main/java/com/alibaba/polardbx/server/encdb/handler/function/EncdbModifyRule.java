...
import com.alibaba.polardbx.server.encdb.handler.EncdbModifyRuleHandler;

import java.util.List;

public class EncdbModifyRule extends AbstractScalarFunction {
    public EncdbModifyRule() {
    }

    public EncdbModifyRule(List<DataType> operandTypes, DataType resultType) {
    ...
    public String[] getFunctionNames() {
        return new String[] {"ENCDB_MODIFY_RULE"};
    }
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        try {
            ...
            List<EncdbRule> encdbRules = EncdbRuleFormat.parseExistEncRule(request);
            int affect = EncdbRuleManager.replaceEncRules(encdbRules) / 2;
