...
public class ColumnarDeltaServiceGrpcComprehensiveTest {

    // 测试私有构造函数（通过反射）
    @Test
    public void testPrivateConstructor() throws Exception {
        // 获取构造函数
        java.lang.reflect.Constructor<ColumnarDeltaServiceGrpc> constructor = 
            ColumnarDeltaServiceGrpc.class.getDeclaredConstructor();
        constructor.setAccessible(true);
        
        // 确保不会抛出异常
        ColumnarDeltaServiceGrpc instance = constructor.newInstance();
