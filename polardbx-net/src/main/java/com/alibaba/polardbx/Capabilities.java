...
public interface Capabilities {
    ...
    // Enable/disable multi-results of prepare stmt, added by chenghui.lch
    // 通知服务器客户端可以处理由COM_STMT_EXECUTE命令包含的多语句或者存储过程执行生成的多结果集。
    // 当打开CLIENT_PS_MULTI_RESULTS时，这个标志自动的被打开。
    int CLIENT_PS_MULTI_RESULTS = 262144;

    int CLIENT_PLUGIN_AUTH = 524288;
