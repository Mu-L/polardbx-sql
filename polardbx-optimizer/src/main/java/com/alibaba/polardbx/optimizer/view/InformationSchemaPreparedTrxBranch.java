 ...
 * @author yaozhili
 */
public class InformationSchemaPreparedTrxBranch extends VirtualView {
    public InformationSchemaPreparedTrxBranch(RelOptCluster cluster, RelTraitSet traitSet) {
        super(cluster, traitSet, VirtualViewType.PREPARED_TRX_BRANCH);
    }

    public InformationSchemaPreparedTrxBranch(RelInput relInput) {
        super(relInput);
    }
