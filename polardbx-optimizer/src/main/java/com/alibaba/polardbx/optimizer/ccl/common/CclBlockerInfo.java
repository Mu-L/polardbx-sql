 ...
 */
@Data
public class CclBlockerInfo {
    private final CclBlockerRecord triggerRecord;
    ...
    public CclBlockerInfo(CclBlockerRecord cclBlockerRecord, List<CclCondition> triggerConditions,
                          List<CclCondition> ruleWiths, List<CclSqlMetricChecker> cclSqlMetricCheckers) {
        this.triggerRecord = cclBlockerRecord;
        this.triggerConditions = triggerConditions;
        this.ruleWiths = ruleWiths;
        this.cclSqlMetricCheckers = cclSqlMetricCheckers;
    }

    public static CclBlockerInfo create(CclBlockerRecord cclBlockerRecord) {

        String conditions = cclBlockerRecord.conditions;
        ...
        String ruleConfig = cclBlockerRecord.ruleConfig;
        ...
        for (CclCondition cclBlockerCondition : triggerConditions) {
            String sqlMetricName = cclBlockerCondition.getSqlMetricName();
            ...
            String comparison = cclBlockerCondition.getComparison();
            ...
            CclSqlMetricChecker cclSqlMetricChecker =
                new CclSqlMetricChecker(checkConditionService, cclBlockerCondition.getValue(),
                    cclSqlMetricValueExtractor);
            cclSqlMetricCheckers.add(cclSqlMetricChecker);
        }

        CclBlockerInfo cclBlockerInfo =
            new CclBlockerInfo(cclBlockerRecord, triggerConditions, ruleWiths, cclSqlMetricCheckers);

        return cclBlockerInfo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof CclBlockerInfo)) {
            return false;
        }

        CclBlockerInfo that = (CclBlockerInfo) obj;
