...
public class CollationHandlers {
    ...
    public final static CollationHandler COLLATION_HANDLER_UTF8_GENERAL_MYSQL500_CI =
        new Utf8CharsetHandler(CollationName.UTF8_GENERAL_MYSQL500_CI).getCollationHandler();
    ...
    public final static CollationHandler COLLATION_HANDLER_GB18030_CHINESE_CI =
        new Gb18030CharsetHandler(CollationName.GB18030_CHINESE_CI).getCollationHandler();
    public final static CollationHandler COLLATION_HANDLER_GB18030_BIN =
