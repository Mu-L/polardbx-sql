...
public abstract class AbstractJoinLAsscomRule extends RelOptRule {
    public AbstractJoinLAsscomRule(RelOptRuleOperand operand, RelBuilderFactory relBuilderFactory, String description) {
