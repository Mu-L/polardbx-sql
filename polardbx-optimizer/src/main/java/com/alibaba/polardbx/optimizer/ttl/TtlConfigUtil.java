...
public class TtlConfigUtil {
     ...
     * the params is used by the IntraTasks generated by ttl-job.
     * <pre>
     *     the ttl-job of "alter table xxx cleanup expired data",
     *     maybe trigger by manually and auto of scheduler.
     ...
     *    That means all the interruptions for out of  maintain time windows,
     *    is impl by execing the "pause/stop ddl" job cmd
     * </pre>
     */
    ...
    /**
     * Label if use the maintain time window for ttl job, default is true
     */
    public static boolean ttlJobMaintenanceEnable =
        Boolean.valueOf(ConnectionParams.TTL_JOB_MAINTENANCE_ENABLE.getDefault());

    /**
     * The start time of maintain windows of ttl-job
     */
    public static String ttlJobMaintenanceTimeStart =
        String.valueOf(ConnectionParams.TTL_JOB_MAINTENANCE_TIME_START.getDefault());

    /**
     * The end time of maintain windows of ttl-job
     */
    public static String ttlJobMaintenanceTimeEnd =
    ...
    public static String getQueryHintForAutoDropParts() {
        return queryHintForAutoDropParts;
    }

    public static void setQueryHintForAutoDropParts(String queryHintForAutoDropParts) {
        TtlConfigUtil.queryHintForAutoDropParts = queryHintForAutoDropParts;
    }

    public static boolean isTtlJobMaintenanceEnable() {
        return ttlJobMaintenanceEnable;
    }

    public static void setTtlJobMaintenanceEnable(boolean ttlJobMaintenanceEnable) {
        TtlConfigUtil.ttlJobMaintenanceEnable = ttlJobMaintenanceEnable;
    }

    public static String getTtlJobMaintenanceTimeStart() {
        return ttlJobMaintenanceTimeStart;
    }

    public static void setTtlJobMaintenanceTimeStart(String ttlJobMaintenanceTimeStart) {
        TtlConfigUtil.ttlJobMaintenanceTimeStart = ttlJobMaintenanceTimeStart;
    }

    public static String getTtlJobMaintenanceTimeEnd() {
