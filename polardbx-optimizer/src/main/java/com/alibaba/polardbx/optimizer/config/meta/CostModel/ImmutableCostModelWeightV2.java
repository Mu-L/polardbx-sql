...
public class ImmutableCostModelWeightV2 implements ICostModelWeightService {
    ...
    private final double startUpWeight = 1.1;

    public ImmutableCostModelWeightV2() {
    }
