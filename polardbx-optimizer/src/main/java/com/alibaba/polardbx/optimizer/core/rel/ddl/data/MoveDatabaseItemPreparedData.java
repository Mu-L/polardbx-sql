 ...
 * @author luoyanxin
 */
public class MoveDatabaseItemPreparedData extends DdlPreparedData {

    private final Map<String, String> sourceTargetGroupMap;

    public MoveDatabaseItemPreparedData(String schemaName, Map<String, String> sourceTargetGroupMap,
                                        String tableName) {
