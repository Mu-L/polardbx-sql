 ...
 * @author dylan
 */
public class ApTest extends PlanTestCommon {
    ...
    public static List<Object[]> prepare() {
        return loadSqls(ApTest.class);
    }

    @Override
    protected void assertPlanProperty(RelNode plan) {
        Assert.assertTrue(PlannerContext.getPlannerContext(plan).getWorkloadType() == WorkloadType.AP);
    }
}