...
public class DeepPagePlanColumnarModeTest extends ParameterizedTestCommon {
    ...
    public DeepPagePlanColumnarModeTest(String caseName, int sqlIndex, String sql, String expectedPlan,
                                        String lineNum) {
    ...
    public static List<Object[]> prepare() {
        return loadSqls(DeepPagePlanColumnarModeTest.class);
    }
