...
public class MqRowCountTest extends ParameterizedTestCommon {
    public MqRowCountTest(String caseName, int sqlIndex, String sql, String expectedPlan,
                          String lineNum) {
    ...
    public static List<Object[]> prepare() {
        return loadSqls(MqRowCountTest.class);
    }
