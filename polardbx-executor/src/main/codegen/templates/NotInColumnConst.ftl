...
<#list notInOperators.operators as operator>
    <#list operator.types as type>

        <#assign className = "NotIn${type.leftType}Col${type.rightType}Const${operator.operandCount}OperandsVectorizedExpression">
