...
export function addExponentiallyWeightedToHistory(value
...
export function getHostname(taskLocation) {
...
export function getPort(taskLocation) {
    return taskLocation.nodeServer.httpPort;
    // return new URL(url).port;
}


export function getHostAndPort(taskLocation) {
...
function formatDataSizeMinUnit(size
