...
class StageOperatorGraph extends React.Component {
    ...
    computeOperatorGraphs(mapInfo, element, operatorMap) {
        ...
        let nodeOperators = operatorMap.get(element.relatedId);
    ...
    computeD3StageOperatorGraph(graph, operator, sink, pipelineNode, pipelineRootNodeMap) {
        ...
        const html = ReactDOMServer.renderToString(<OperatorSummary
                            ...
                            <div className="col-xs-2 stage-dropdown">
                                <div className="input-group-btn">
                                    ...
                                    <ul className="dropdown-menu">
                                        {allStages.map(stageId => (<li key={stageId}><a
