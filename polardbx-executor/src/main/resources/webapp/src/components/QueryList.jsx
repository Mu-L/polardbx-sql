...
export class QueryListItem extends React.Component {
    ...
    renderWarning() {
        ...
        if (query.warnings && query.warnings.length) {
            ...
            return (
                <span className="glyphicon glyphicon-warning-sign query-warning" data-toggle="tooltip"
    ...
    render() {
        ...
        const timingDetails = (
            <div className="col-xs-12 tinystat-row">
                <span className="tinystat" data-toggle="tooltip" data-placement="top"
                ...
                <span className="tinystat" data-toggle="tooltip" data-placement="top" title="Plan Time by this query">
                    ...
                    <div className="col-xs-8">
                            ...
                            <div className="col-xs-12 query-progress-container">
                                <div className="progress">
                                    <div className="progress-bar progress-bar-info" role="progressbar"
                                         aria-valuenow={getProgressBarPercentage(query)} aria-valuemin="0"
                        ...
                        <div className="row query-row-bottom">
                            <div className="col-xs-12">
                                <pre className="query-snippet"><code
                                    className="sql">{QueryListItem.stripQueryTextWhitespace(query.query)}</code></pre>
                            </div>
                        </div>
                    </div>
                </div>
...
export class QueryList extends React.Component {
    ...
    renderMaxQueriesListItem(maxQueries, maxQueriesText) {
        return (
            <li><a href="#" className={this.state.maxQueries === maxQueries ? "selected" : ""}
    ...
    renderReorderListItem(interval, intervalText) {
        return (
            <li><a href="#" className={this.state.reorderInterval === interval ? "selected" : ""}
                    ...
                    <div className="col-xs-12 toolbar-col">
                        <div className="input-group input-group-sm">
                            ...
                            <div className="input-group-btn">
                                ...
                                <button type="button" id="error-type-dropdown"
