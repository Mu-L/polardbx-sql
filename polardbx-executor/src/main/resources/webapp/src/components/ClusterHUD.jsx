...
export class ClusterHUD extends React.Component {
    ...
    componentDidUpdate() {
        ...
        if (this.state.lastRender === null || (Date.now() - this.state.lastRender) >= 1000) {
            ...
            $('#running-queries-sparkline').sparkline(this.state.totalQueries, $.extend({}, SPARKLINE_PROPERTIES, {chartRangeMin: 0}));
        ...
        return (<div className="row">
            <div className="col-xs-12">
                    ...
                    <div className="col-xs-4">
                        <div className="stat stat-large">
                            <span className="stat-text">
                                {this.state.totalQueries[this.state.totalQueries.length - 1]}
                            </span>
                ...
                <div className="row">
                    ...
                    <div className="col-xs-4">
                        <div className="stat-title">
                            <span className="text" data-toggle="tooltip" data-placement="right" title="Moving average of total running PipelineExecs">
                                Runnable PipelineExecs
                            </span>
                        </div>
                    </div>
                    <div className="col-xs-4">
