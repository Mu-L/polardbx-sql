...
export class WorkerThreadList extends React.Component {
    ...
    renderGroupListItem(group) {
        return (
            <li key={group}>
                <a href="#" className={this.state.selectedGroup === group ? "selected" : ""}
    ...
    renderThreadStateListItem(threadState) {
        return (
            <li key={threadState}>
                <a href="#" className={this.state.selectedThreadState === threadState ? "selected" : ""}
    ...
    render() {
        ...
        if (threads === null) {
                    ...
                    <div className="row error-message">
                        <div className="col-xs-12">
                            <button className="btn btn-info live-button"
                                    onClick={this.handleNewSnapshotClick.bind(this)}>Capture Snapshot
                            </button>
                        </div>
                    </div>
                );
                ...
                <div className="col-xs-9">
                    <table className="header-inline-links">
                        ...
                        <tr>
                            ...
                            <td>
                                <button className="btn btn-info live-button"
                                        onClick={this.handleNewSnapshotClick.bind(this)}>New Snapshot
                                </button>
                                &nbsp;&nbsp;
                                &nbsp;&nbsp;
                            </td>
                            ...
                            <td>
                                <div className="input-group-btn text-right">
                                    <button type="button"
                                            ...
                                            data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                                        <strong>State:</strong> {this.state.selectedThreadState} <span
                                        className="caret"/>
                                    </button>
                                    <ul className="dropdown-menu">
            ...
            if (filteredThreads.length === 0 && this.state.selectedThreadState === ALL_THREAD_STATE) {
                ...
                displayedThreads = (
                    <div className="row error-message">
                        <div className="col-xs-12"><h4>No threads in group '{this.state.selectedGroup}' with
                            state {this.state.selectedThreadState}</h4></div>
                    </div>);
            }
            else {
                displayedThreads = (
            ...
            <div>
                <div className="row">
                    <div className="col-xs-3">
                        <h3>
                            Thread Snapshot
                            <a className="btn copy-button" data-clipboard-target="#stack-traces" data-toggle="tooltip"
