...
public class CheckSumAccumulator extends AbstractAccumulator {
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(CheckSumAccumulator.class).instanceSize();
