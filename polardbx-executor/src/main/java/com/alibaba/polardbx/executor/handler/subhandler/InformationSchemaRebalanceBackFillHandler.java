...
public class InformationSchemaRebalanceBackFillHandler extends BaseVirtualViewSubClassHandler {
    ...
    public static Cursor buildRebalanceBackFillView(ArrayResultCursor cursor) {
        ...
        ddlRecordList = ddlRecordList.stream().filter(e -> DdlType.valueOf(e.ddlType) == DdlType.REBALANCE)
    ...
    private static void addRow(ArrayResultCursor cursor, long jobId, long taskId, String schemaName,
                               String startTime,
                               String state, Object currentSpeed, Object averageSpeed, long finishedRows,
                               long totalRows) {
        cursor.addRow(new Object[] {
            jobId, taskId, schemaName, startTime, state, currentSpeed, averageSpeed, finishedRows, totalRows});
    }
