...
public class FastEQDecimalColLongConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastEQDecimalColLongConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
