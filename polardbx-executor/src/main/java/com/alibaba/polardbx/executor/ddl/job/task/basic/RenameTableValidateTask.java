...
public class RenameTableValidateTask extends BaseValidateTask {

    private String logicalTableName;
    private String newLogicalTableName;

    @JSONCreator
    public RenameTableValidateTask(String schemaName, String logicalTableName, String newLogicalTableName) {
        super(schemaName);
    ...
    protected String remark() {
        return String.format("|from %s to %s", logicalTableName, newLogicalTableName);
    }
