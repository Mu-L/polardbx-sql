...
@Getter
@TaskName(name = "DropTableHideTableMetaTask")
public class DropTableHideTableMetaTask extends BaseGmsTask {

    @JSONCreator
    public DropTableHideTableMetaTask(String schemaName, String logicalTableName) {
