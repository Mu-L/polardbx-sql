...
public class DirectJsonColumnReader extends DirectVarcharColumnReader {
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(DirectJsonColumnReader.class).instanceSize();
    ...
    public DirectJsonColumnReader(int columnId, boolean isPrimaryKey, StripeLoader stripeLoader,
