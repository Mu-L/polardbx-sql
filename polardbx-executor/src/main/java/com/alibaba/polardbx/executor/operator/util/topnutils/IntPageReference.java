...
public class IntPageReference implements MemoryCountable {
    private static final long INSTANCE_SIZE = ClassLayout.parseClass(IntPageReference.class).instanceSize();

    private Chunk page;

    @ShallowHeap
    private IntIndexRow[] reference;
    ...
    public IntPageReference(Chunk page, List<DataType> sourceTypes, ExecutionContext context,
                            OrderByOption orderByOption) {
        this.page = requireNonNull(page, "page is null");
        this.reference = new IntIndexRow[page.getPositionCount()];
    ...
    public void reference(IntIndexRow row) {
    ...
    public void compact() {
        ...
        // re-assign reference
        IntIndexRow[] newReference = new IntIndexRow[usedPositionCount];
        ...
        for (int i = 0; i < usedPositionCount; i++) {
            ...
            int value = page.getBlock(orderByOption.index).getInt(i);
