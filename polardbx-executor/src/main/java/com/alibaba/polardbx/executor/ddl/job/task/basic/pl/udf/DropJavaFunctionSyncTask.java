...
@Getter
@TaskName(name = "DropJavaFunctionSyncTask")
public class DropJavaFunctionSyncTask extends BaseSyncTask {

    private String functionName;

    @JSONCreator
    public DropJavaFunctionSyncTask(String schemaName, String functionName) {
        super(schemaName);
