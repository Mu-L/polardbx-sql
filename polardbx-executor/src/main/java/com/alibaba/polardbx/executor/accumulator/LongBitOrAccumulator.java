...
public class LongBitOrAccumulator extends AbstractAccumulator {
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(LongBitOrAccumulator.class).instanceSize();
    ...
    LongBitOrAccumulator(int capacity) {
