 ...
 */
public class GsiLoader extends Loader {
    ...
    public static Loader create(String schemaName, String primaryTable, String indexTable,
        ...
        final TableMeta indexTableMeta = optimizerContext.getLatestSchemaManager().getTable(indexTable);
        ...
        return new GsiLoader(schemaName,
            indexTable,
            sqlInsert,
            sqlInsertIgnore,
            checkerPlan,
