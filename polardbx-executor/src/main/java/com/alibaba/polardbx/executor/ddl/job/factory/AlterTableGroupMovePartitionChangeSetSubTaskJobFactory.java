...
public class AlterTableGroupMovePartitionChangeSetSubTaskJobFactory extends AlterTableGroupChangeSetJobFactory {

    final AlterTableGroupMovePartitionPreparedData parentPrepareData;

    public AlterTableGroupMovePartitionChangeSetSubTaskJobFactory(DDL ddl,
        ...
        super(ddl, parentPrepareData, preparedData, phyDdlTableOperations, discardTableSpaceOperations,
            ...
            orderedTargetTableLocations, targetPartition, false,
