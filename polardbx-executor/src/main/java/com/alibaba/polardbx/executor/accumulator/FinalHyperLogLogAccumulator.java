...
public class FinalHyperLogLogAccumulator extends AbstractAccumulator {
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(FinalHyperLogLogAccumulator.class).instanceSize();
