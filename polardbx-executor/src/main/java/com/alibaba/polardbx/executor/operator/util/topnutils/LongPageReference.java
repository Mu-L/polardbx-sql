...
public class LongPageReference implements MemoryCountable {
    private static final long INSTANCE_SIZE = ClassLayout.parseClass(LongPageReference.class).instanceSize();
    ...
    public LongPageReference(Chunk page, List<DataType> sourceTypes, ExecutionContext context,
    ...
    public void compact() {
        ...
        for (int i = 0; i < usedPositionCount; i++) {
            ...
            long value = page.getBlock(orderByOption.index).getLong(i);
