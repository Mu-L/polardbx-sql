...
@Getter
@TaskName(name = "CreateJavaFunctionSyncTask")
public class CreateJavaFunctionSyncTask extends BaseDdlTask {

    private String functionName;

    @JSONCreator
    public CreateJavaFunctionSyncTask(String schemaName, String functionName) {
        super(schemaName);
