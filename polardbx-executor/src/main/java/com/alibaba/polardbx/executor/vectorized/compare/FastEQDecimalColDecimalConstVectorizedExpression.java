...
public class FastEQDecimalColDecimalConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastEQDecimalColDecimalConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
        ...
        if (useDecimal128Compare) {
            ...
            if (isSelectionInUse) {
                for (int i = 0; i < batchSize; i++) {
                    ...
                    boolean equal = leftHigh == rightHigh && leftLow == rightLow;
