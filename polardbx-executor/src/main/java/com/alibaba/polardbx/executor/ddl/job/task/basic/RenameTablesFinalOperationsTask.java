 ...
 */
@Getter
@TaskName(name = "RenameTablesFinalOperationsTask")
public class RenameTablesFinalOperationsTask extends BaseGmsTask {

    private List<String> oldTableNames;
    private List<String> newTableNames;

    @JSONCreator
    public RenameTablesFinalOperationsTask(String schemaName, List<String> oldTableNames, List<String> newTableNames) {
