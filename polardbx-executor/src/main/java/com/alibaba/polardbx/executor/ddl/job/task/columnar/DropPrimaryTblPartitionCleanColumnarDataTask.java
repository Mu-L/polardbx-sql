...
public class DropPrimaryTblPartitionCleanColumnarDataTask extends BaseDdlTask {
    ...
    protected void duringTransaction(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        PrimaryTblCleanColumnarDataUtils.PartitionNamesProvider partitionNamesProvider =
            (schemaName, tableName) -> PrimaryTblCleanColumnarDataUtils.getSpecifiedPartitionNames(
                schemaName, tableName, partitionNames, isSubPartition);
        ...
        DdlEngineAccessorDelegate delegate = new DdlEngineAccessorDelegate<Integer>() {
            ...
            protected Integer invoke() {
                synchronized (DropPrimaryTblPartitionCleanColumnarDataTask.this) {
                    ...
                    // 更新状态并写回数据库
                    DropPrimaryTblPartitionCleanColumnarDataTask.this.setDnCleanedPhyPartSetMap(
                        newestDnCleanedPhyPartSetMap);
                    DropPrimaryTblPartitionCleanColumnarDataTask.this.setCurrentTotalRows(currentTotalRows);
                    DropPrimaryTblPartitionCleanColumnarDataTask.this.setCurrentTotalTime(currentTotalTime);
                    DropPrimaryTblPartitionCleanColumnarDataTask.this.setTaskStartTime(taskStartTime);
                    DropPrimaryTblPartitionCleanColumnarDataTask.this.setCurrentSpeed(currentSpeed);
        ...
        DdlEngineAccessorDelegate delegate = new DdlEngineAccessorDelegate<Integer>() {
            ...
            protected Integer invoke() {
                synchronized (DropPrimaryTblPartitionCleanColumnarDataTask.this) {
                    ...
                    // 更新状态并写回数据库
                    DropPrimaryTblPartitionCleanColumnarDataTask.this.setDnPartitionToLastPKMap(
