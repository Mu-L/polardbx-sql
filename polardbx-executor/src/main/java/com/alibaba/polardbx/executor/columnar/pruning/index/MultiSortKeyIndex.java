...
public class MultiSortKeyIndex extends BaseColumnIndex {

    final Map<Integer, ArrayList<Object>> dataMap;
    final Map<Integer, DataType> dtMap;
    final Map<Integer, RoaringBitmap> nullValMap;
    private long sizeInBytes = -1;

    // internal fields
    private Map<Integer, Collection<RoaringBitmap>> groupDataMap = Maps.newConcurrentMap();

    private MultiSortKeyIndex(long rgNum, Map<Integer, DataType> dtMap, Map<Integer, ArrayList<Object>> dataMap,
        ...
        for (int index : dataMap.keySet()) {
            ...
            if (DataTypes.LongType.equals(dt) ||
                ...
                DataTypeUtil.isUnderIntType(dt)) {
    ...
    public static MultiSortKeyIndex build(long rgNum, Map<Integer, DataType> dtMap,
                                          Map<Integer, ArrayList<Object>> dataMap,
                                          Map<Integer, RoaringBitmap> nullValMap) {
        ...
        return new MultiSortKeyIndex(rgNum, dtMap, dataMap, nullValMap);
    }
     ...
     * @param startObj lower value
     * @param includeStart is lower value included
     * @param endObj upper value
     ...
     */
    void search(int colId, Object target, SqlKind sqlKind, RoaringBitmap cur) {
    ...
    public boolean checkSupport(int columnId, SqlTypeName type) {
        ...
        return type == SqlTypeName.BIGINT ||
            ...
            type == SqlTypeName.TINYINT_UNSIGNED ||
            type == SqlTypeName.SMALLINT ||
            type == SqlTypeName.SMALLINT_UNSIGNED ||
            type == SqlTypeName.MEDIUMINT ||
            type == SqlTypeName.MEDIUMINT_UNSIGNED ||
            type == SqlTypeName.INTEGER_UNSIGNED;
    }
