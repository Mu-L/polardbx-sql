 ...
 */
public class LookupTableSortRangeScanExec extends RangeScanSortExec implements MultiUnionAllLookupTableExec {
    ...
    public LookupTableSortRangeScanExec(LogicalView logicalView, ExecutionContext context, TableScanClient scanClient,
                                        long maxRowCount,
