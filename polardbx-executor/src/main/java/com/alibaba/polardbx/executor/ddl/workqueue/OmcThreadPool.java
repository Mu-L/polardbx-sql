 ...
 * @author wumu
 */
public class OmcThreadPool {
    private static volatile OmcThreadPool instance = null;
    ...
    public static OmcThreadPool getInstance() {
        if (instance == null) {
            synchronized (OmcThreadPool.class) {
                if (instance == null) {
                    instance = new OmcThreadPool();
                }
            }
        }
        return instance;
    ...
    public OmcInfo queryCheckTaskInfo(long ddlJobId) {
        try {
