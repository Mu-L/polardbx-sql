...
public class LogicalAlterTableGroupDropPartitionHandler extends LogicalCommonDdlHandler {
    ...
    public LogicalAlterTableGroupDropPartitionHandler(IRepository repo) {
        super(repo);
    }
    ...
    protected DdlJob buildDdlJob(BaseDdlOperation logicalDdlPlan, ExecutionContext executionContext) {
        ...
        return AlterTableGroupDropPartitionJobFactory
            .create(logicalAlterTableGroupDropPartition.relDdl, logicalAlterTableGroupDropPartition.getPreparedData(),
                executionContext);
    }
