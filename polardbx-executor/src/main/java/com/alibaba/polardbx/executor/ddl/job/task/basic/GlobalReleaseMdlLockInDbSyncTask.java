...
@Getter
@TaskName(name = "GlobalReleaseMdlLockInDbSyncTask")
public class GlobalReleaseMdlLockInDbSyncTask extends BaseSyncTask {
    final Set<String> schemaNames;

    public GlobalReleaseMdlLockInDbSyncTask(String srcSchema, Set<String> schemaNames) {
        super(srcSchema);
