...
public class ReversedAntiJoinRFTest extends PlanFragmentTestBase {
    protected String expectedFragment;

    public ReversedAntiJoinRFTest(String caseName, int sqlIndex, String sql, String expectedPlan, String lineNum,
                                  String expectedFragment) {
        super(caseName, FragmentRFScheduleTest.class.getSimpleName(), sqlIndex, sql, expectedPlan, lineNum,
            new ReversedAntiJoinRFTester());
    ...
    private static class ReversedAntiJoinRFTester extends AbstractPlanFragmentTester {
        public ReversedAntiJoinRFTester() {
            super(16, 1, 16);
        }
