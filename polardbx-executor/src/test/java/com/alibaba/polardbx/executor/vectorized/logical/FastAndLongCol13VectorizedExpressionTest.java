...
public class FastAndLongCol13VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        LongBlock[] blocks = new LongBlock[13];
        for (int i = 0; i < 13; i++) {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        VectorizedExpression[] children = new VectorizedExpression[13];
        for (int i = 0; i < 13; i++) {
            children[i] = new EQLongColCharConstVectorizedExpression(13 + i,
        ...
        FastAndLongCol13VectorizedExpression condition = new FastAndLongCol13VectorizedExpression(26, children);
