...
public class DictDecimalColumnReader2Test extends DecimalScanTestBase {
    ...
    protected void initSchema() {
        ...
        SCHEMA.addField("2209__id__", TypeDescription.createLong());
        SCHEMA.addField("2210__id__", TypeDescription.createDecimal().withPrecision(20).withScale(2));
