...
public class LogicalShowCreateTablesForPartitionDatabaseHandlerTest extends LogicalShowCreateTableTest {
    ...
    public void showWithMySqlIndentTest() {
        ...
        try (final MockedStatic<OptimizerContext> mockOptimizerContextStatic = mockStatic(OptimizerContext.class);
            ...
            // Set SHOW_HASH_PARTITIONS_BY_RANGE
            ParamManager.setBooleanVal(ec.getParamManager().getProps(), SHOW_HASH_PARTITIONS_BY_RANGE, true, true);
