...
public class FastAndLongCol12VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        LongBlock[] blocks = new LongBlock[12];
        for (int i = 0; i < 12; i++) {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        VectorizedExpression[] children = new VectorizedExpression[12];
        for (int i = 0; i < 12; i++) {
            children[i] = new EQLongColCharConstVectorizedExpression(12 + i,
        ...
        FastAndLongCol12VectorizedExpression condition = new FastAndLongCol12VectorizedExpression(24, children);
