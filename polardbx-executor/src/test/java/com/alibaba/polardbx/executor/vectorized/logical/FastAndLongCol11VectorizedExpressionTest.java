...
public class FastAndLongCol11VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        LongBlock[] blocks = new LongBlock[11];
        for (int i = 0; i < 11; i++) {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        VectorizedExpression[] children = new VectorizedExpression[11];
        for (int i = 0; i < 11; i++) {
            children[i] = new EQLongColCharConstVectorizedExpression(11 + i,
        ...
        FastAndLongCol11VectorizedExpression condition = new FastAndLongCol11VectorizedExpression(22, children);
