...
public class FastAndLongCol7VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        ...
        Chunk inputChunk = new Chunk(block1.getPositionCount(), block1, block2, block3, block4, block5, block6, block7);
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        VectorizedExpression[] children = new VectorizedExpression[7];
        for (int i = 0; i < 7; i++) {
        ...
        FastAndLongCol7VectorizedExpression condition = new FastAndLongCol7VectorizedExpression(14, children);
