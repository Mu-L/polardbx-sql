...
public class EarlyStopManagerIntColTest {
    @Test
    public void testIntPrefixDesc() {
        ...
        try (MockedStatic<ColumnarManager> columnarManagerMockedStatic = Mockito.mockStatic(ColumnarManager.class)) {
            ...
            Mockito.when(globalTopNThreshold.getTopNThresholdType())
                .thenReturn(GlobalTopNThreshold.TopNThresholdType.INT);
            ...
            Mockito.when(globalTopNThreshold.getIntThreshold()).thenReturn(0);
            Mockito.when(globalTopNThreshold.isNull()).thenReturn(true);
            Mockito.when(block.getInt(anyInt())).thenReturn(1);
            ...
            Mockito.when(globalTopNThreshold.getIntThreshold()).thenReturn(3);
    ...
    public void testIntAsc() {
        ...
        try (MockedStatic<ColumnarManager> columnarManagerMockedStatic = Mockito.mockStatic(ColumnarManager.class)) {
            ...
            Block block = Mockito.mock(Block.class);
            Mockito.when(chunk.getBlock(0)).thenReturn(block);
            Mockito.when(globalTopNThreshold.getIntThreshold()).thenReturn(1000);
            Mockito.when(globalTopNThreshold.isNull()).thenReturn(false);
            Mockito.when(block.getInt(anyInt())).thenReturn(1);
            Mockito.when(block.isNull(anyInt())).thenReturn(false);
