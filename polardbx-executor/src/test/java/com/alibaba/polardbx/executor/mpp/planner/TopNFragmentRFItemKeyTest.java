...
public class TopNFragmentRFItemKeyTest {
    ...
    @Test
    public void test() {
        List<FragmentRFItemKey> rfItemKeys = FragmentRFItemKey.buildItemKeys(topN);

        Assert.assertTrue(rfItemKeys.get(0).getBuildColumnName().equals("f1"));
        Assert.assertTrue(rfItemKeys.get(0).getProbeColumnName().equals("f1"));
        Assert.assertTrue(rfItemKeys.get(0).getBuildIndex() == 0);
        Assert.assertTrue(rfItemKeys.get(0).getProbeIndex() == 0);
        Assert.assertTrue(rfItemKeys.get(0).getSqlKind() == SqlKind.LESS_THAN);

        Assert.assertTrue(rfItemKeys.get(1).getBuildColumnName().equals("f2"));
        Assert.assertTrue(rfItemKeys.get(1).getProbeColumnName().equals("f2"));
        Assert.assertTrue(rfItemKeys.get(1).getBuildIndex() == 1);
        Assert.assertTrue(rfItemKeys.get(1).getProbeIndex() == 1);
        Assert.assertTrue(rfItemKeys.get(1).getSqlKind() == SqlKind.GREATER_THAN);
    }
}
