...
public class FastAndLongCol5VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        ...
        Chunk inputChunk = new Chunk(block1.getPositionCount(), block1, block2, block3, block4, block5);
    ...
    public void testMixed() {
        ...
        Chunk inputChunk = new Chunk(block1.getPositionCount(), block1, block2, block3, block4, block5);
        // Result: (1==1) AND (1==1) AND (1==1) AND (1==1) AND (1==1) = true
        //         (0==1) AND ... = false
    ...
    public void testWithNull() {
        ...
        Chunk inputChunk = new Chunk(block1.getPositionCount(), block1, block2, block3, block4, block5);
        // Result: true AND true AND true AND true AND true = true
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        // Create FastAndLongCol5VectorizedExpression with 5 EQLongColCharConstVectorizedExpression children
        // Each child compares a Long column with value 1 (i.e., col == 1)
        VectorizedExpression[] children = new VectorizedExpression[5];
        for (int i = 0; i < 5; i++) {
            children[i] = new EQLongColCharConstVectorizedExpression(
                5 + i, // output index for each child
        ...
        FastAndLongCol5VectorizedExpression condition = new FastAndLongCol5VectorizedExpression(
            10, // output index (after 5 input columns + 5 child outputs)
            children
        );

        // Placeholder for input and output blocks
        // Need slots for: 5 input columns + 5 child outputs + 1 final output
