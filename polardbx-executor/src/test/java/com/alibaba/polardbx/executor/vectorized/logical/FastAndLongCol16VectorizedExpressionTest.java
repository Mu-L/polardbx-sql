...
public class FastAndLongCol16VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        LongBlock[] blocks = new LongBlock[16];
        for (int i = 0; i < 16; i++) {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        VectorizedExpression[] children = new VectorizedExpression[16];
        for (int i = 0; i < 16; i++) {
            children[i] = new EQLongColCharConstVectorizedExpression(16 + i,
        ...
        FastAndLongCol16VectorizedExpression condition = new FastAndLongCol16VectorizedExpression(32, children);
