...
public class WarmupTaskManagerCancelTest {
    ...
    public void test() throws InterruptedException {
        ...
        final long taskId = 12345;

        Executors.newSingleThreadExecutor().submit(
            () -> {
                while (!warmupTaskManager.isCancelled()) {
                    warmupTaskManager.cancelTask(taskId);
                    ...
                    warmupTaskManager.clearCanceledTasks();
                }
            }
        );
        ...
        Executors.newSingleThreadExecutor().submit(() -> {
            ...
            // sql exception:
            warmupTaskManager.addTask(taskId + 1, schemaName, "select 1 from dual", instId, cronExpr,
                nextExecutionTime);
