...
public class DictDecimalColumnReader1Test extends DecimalScanTestBase {
    ...
    protected void initSchema() {
        ...
        SCHEMA.addField("2203__id__", TypeDescription.createLong());
        SCHEMA.addField("2204__id__", TypeDescription.createDecimal().withPrecision(20).withScale(2));
