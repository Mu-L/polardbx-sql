...
public class EarlyStopManagerLongColTest {
    @Test
    public void testLongPrefixDesc() {
        ...
        try (MockedStatic<ColumnarManager> columnarManagerMockedStatic = Mockito.mockStatic(ColumnarManager.class)) {
            ...
            Mockito.when(globalTopNThreshold.getTopNThresholdType())
                .thenReturn(GlobalTopNThreshold.TopNThresholdType.LONG);
            ...
            Mockito.when(block.getLong(anyInt())).thenReturn(1L);
