...
public class FastAndLongCol9VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        LongBlock[] blocks = new LongBlock[9];
        for (int i = 0; i < 9; i++) {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        VectorizedExpression[] children = new VectorizedExpression[9];
        for (int i = 0; i < 9; i++) {
            children[i] = new EQLongColCharConstVectorizedExpression(9 + i,
        ...
        FastAndLongCol9VectorizedExpression condition = new FastAndLongCol9VectorizedExpression(18, children);
