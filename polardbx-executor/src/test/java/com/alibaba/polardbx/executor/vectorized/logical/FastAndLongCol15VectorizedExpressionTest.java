...
public class FastAndLongCol15VectorizedExpressionTest {
    ...
    public void testAllTrue() {
        LongBlock[] blocks = new LongBlock[15];
        for (int i = 0; i < 15; i++) {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        VectorizedExpression[] children = new VectorizedExpression[15];
        for (int i = 0; i < 15; i++) {
            children[i] = new EQLongColCharConstVectorizedExpression(15 + i,
        ...
        FastAndLongCol15VectorizedExpression condition = new FastAndLongCol15VectorizedExpression(30, children);
