 ...
 * @author fangwu
 */
public class LongSortKeyAscIndexTest {

    private boolean isAsc = true;

    @Test
    public void testEqual() {
        long[] data = new long[] {10000, 20000, 40000, 70000, 70000, 70050, 80000, 100000};
        LongSortKeyIndex sortKeyIndex = LongSortKeyIndex.build(1, data, DataTypes.LongType, isAsc);
