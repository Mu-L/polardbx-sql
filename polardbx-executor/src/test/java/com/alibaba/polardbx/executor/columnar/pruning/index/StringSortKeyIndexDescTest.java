...
public class StringSortKeyIndexDescTest {
    private final String[] data = new String[] {"xxx", "zzz", "ggg", "jjj", "ddd", "ggg", "aaa", "bbb"};

    private final StringSortKeyIndex sortKeyIndex = StringSortKeyIndex.build(1, data, DataTypes.StringType, false);
    ...
    public void testRange() {
        ...
        rs.stream().forEachOrdered(System.out::println);
        Assert.assertTrue(rs.getCardinality() == 2 && rs.contains(2) && rs.contains(2));
        ...
        rs.stream().forEachOrdered(System.out::println);
        Assert.assertTrue(
            rs.getCardinality() == 4 && rs.contains(0) && rs.contains(0) && rs.contains(1) && rs.contains(2));
