...
public class TestInnerConnection implements IInnerConnection {

    private long executionTimeInMillis;
    private Map<String, ArrayResultSet> sqlAndResultSet;

    TestInnerConnection(long executionTimeInMillis, Map<String, ArrayResultSet> sqlAndResultSet) {
        this.executionTimeInMillis = executionTimeInMillis;
        this.sqlAndResultSet = sqlAndResultSet;
    }
    ...
    private static class TestStatement implements Statement {
        ...
        public TestStatement(long executionTimeInMillis, Map<String, ArrayResultSet> sqlAndResultSet) {
            this.executionTimeInMillis = executionTimeInMillis;
            this.sqlAndResultSet = sqlAndResultSet;
        }
        ...
        public ResultSet executeQuery(String sql) throws SQLException {
            if (sqlAndResultSet.containsKey(sql)) {
                try {
                    Thread.sleep(executionTimeInMillis);
                } catch (InterruptedException e) {
                    throw new RuntimeException(e);
                }
                return sqlAndResultSet.get(sql);
            }
    ...
    public Statement createStatement() throws SQLException {
        return new TestStatement(executionTimeInMillis, sqlAndResultSet);
    }
