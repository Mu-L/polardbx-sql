...
public enum OrcConf {
  ...
  USE_REDUNDANT_META_DATA("orc.write.use.redundant.metadata",
      "hive.exec.orc.write.use.redundant.metadata", true,
      "Use redundant meta to store row indexes in orc tail"),
  USE_BINARY_META_DATA("orc.write.use.binary.metadata",
      "hive.exec.orc.write.use.binary.metadata", true,
      "Use binary meta to store row indexes in orc tail"),
  ...
  PROLEPTIC_GREGORIAN_DEFAULT("orc.proleptic.gregorian.default",
      ...
      "is the default."),
  MAX_MERGE_DISTANCE("orc.max.merge.distance", "hive.max.merge.distance", 64L * 1024, "merge max distance of disk io")
  ;
