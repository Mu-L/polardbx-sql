...
public class ConcurrentUpsertTest extends Omc30DmlBaseTest {
    ...
    public void modifyWithUpsert1() throws Exception {
        ...
        String colDef = "int";
        String alterSql = "alter table %s modify column b bigint, modify column c longtext";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator =
            (count) -> String.format(
                "insert into %%s(a,b,c,d) values(%d, %d,null,null) on duplicate key update b=b+%d,c = b",
    ...
    public void modifyWithUpsert2() throws Exception {
        ...
        String colDef = "int";
        String alterSql = "alter table %s modify column b bigint, modify column d char(20) character set gbk";
        String selectSql = "select * from %s order by a desc";
        Function<Integer, String> generator =
            (count) -> String.format(
                "insert into %%s(a,b,c,d) values(%d, %d,null,null) on duplicate key update a=a+%d,d = a",
                count, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
    ...
    public void modifyWithUpsert3() throws Exception {
        ...
        String selectSql = "select * from %s order by a desc";
        Function<Integer, String> generator =
            (count) -> String.format(buildCmdExtra(USE_LOGICAL_EXECUTION, ENABLE_LOCAL_UK_FULL_TABLE_SCAN)
                    + "insert into %%s(a,b,c,d) values(%d + %d, %d,null,null) on duplicate key update a=a+%d",
    ...
    public void modifyWithUpsert4() throws Exception {
        ...
        String colDef = "int unique key";
        String alterSql = "alter table %s modify column b char(20)";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator =
            (count) -> String.format(
                "insert into %%s(a,b,c,d) values(%d, %d + %d,null,null) on duplicate key update b=b+%d",
    ...
    public void modifyWithUpsert5() throws Exception {
        ...
        String alterSql = "alter table %s modify column b bigint default 4, modify column c varchar(20) default 'xyz'";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator =
            (count) -> String.format(
                "insert into %%s(a,b,c,d) values(%d, %d + %d,null,null) on duplicate key update b=default,c=default",
                count, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
    ...
    public void modifyWithUpsert6() throws Exception {
        ...
        String colDef = "int default 3";
        String alterSql = "alter table %s modify column b bigint default 4, modify column d char(10) default 'xyz'";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator =
            (count) -> String.format(
                "insert into %%s(a,b,c,d) values(%d, %d + %d,null,null) on duplicate key update b=default(b),c=default(d)",
                count, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
    ...
    public void changeWithUpsert1() throws Exception {
        String tableName = "omc_with_upsert_1";
        String colDef = "int";
        String alterSql = "alter table %s change column b e bigint, change column c f char(10)";
        String selectSql = "select * from %s order by a";
        ...
        Function<Integer, String> generator2 =
            (count) -> String.format(
                "insert into %%s(a,e,f,d) values(%d, %d,null,null) on duplicate key update e=e+%d,f=e",
                count, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
            (colA, colB, colC, colD) -> (colA + FILL_COUNT == colB) && (Float.parseFloat(colC) == colB);
        concurrentTestInternal30(tableName, colDef, alterSql, selectSql, generator1, generator2,
            checker, true);
    }
    ...
    public void changeWithUpsert2() throws Exception {
        ...
        String selectSql = "select * from %s order by a desc";
        Function<Integer, String> generator1 =
            (count) -> String.format("insert into %%s(a,b,c,d) values(%d, %d,null,null) on duplicate key update a=a+%d",
                count,
                count, FILL_COUNT);
        Function<Integer, String> generator2 =
            (count) -> String.format("insert into %%s(a,e,c,d) values(%d, %d,null,null) on duplicate key update a=a+%d",
                count,
                count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
            (colA, colB, colC, colD) -> colA - FILL_COUNT == colB;
    ...
    public void changeWithUpsert3() throws Exception {
        ...
        Function<Integer, String> generator2 =
            (count) -> String.format(buildCmdExtra(USE_LOGICAL_EXECUTION, ENABLE_LOCAL_UK_FULL_TABLE_SCAN)
                    + "insert into %%s(a,e,c,d) values(%d + %d, %d,null,null) on duplicate key update a=a+%d",
                count, FILL_COUNT, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
            (colA, colB, colC, colD) -> colA - FILL_COUNT == colB;
        concurrentTestInternal30(tableName, colDef, alterSql, selectSql, generator1, generator2,
    ...
    public void changeWithUpsert4() throws Exception {
        ...
        Function<Integer, String> generator2 =
            (count) -> String.format(
                "insert into %%s(a,e,c,d) values(%d, %d + %d,null,null) on duplicate key update e=e+%d",
                count, count, FILL_COUNT, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
            (colA, colB, colC, colD) -> colA + FILL_COUNT == colB;
        concurrentTestInternal30(tableName, colDef, alterSql, selectSql, generator1, generator2,
    ...
    public void changeWithUpsert5() throws Exception {
        String tableName = "omc_with_upsert_5";
        String colDef = "int default 3";
        String alterSql = "alter table %s change column b e bigint default 4, change column c f char(10) default 'xyz'";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator1 =
            (count) -> String.format(
                "insert into %%s(a,b,c,d) values(%d, %d + %d,null,null) on duplicate key update b=default,c=default",
        ...
        Function<Integer, String> generator2 =
            (count) -> String.format(
                "insert into %%s(a,e,f,d) values(%d, %d + %d,null,null) on duplicate key update e=default,f=default",
                count, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
    ...
    public void changeWithUpsert6() throws Exception {
        ...
        Function<Integer, String> generator2 =
            (count) -> String.format(
                "insert into %%s(a,e,f,g) values(%d, %d + %d,null,null) on duplicate key update e=default(e),f=default(g)",
                count, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
            (colA, colB, colC, colD) -> (colB == 3 || colB == 4)
    ...
    public void changeWithUpsert7() throws Exception {
        ...
        String colDef = "int default 3";
        String alterSql =
            "alter table %s change column b e bigint default 4, change column c f varchar(7) default 'aaa', change column d g char(10) default 'xyz'";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator1 =
            (count) -> String.format(
                "insert into %%s(a,b,c,d) values(%d, %d + %d,null,null) on duplicate key update b=default(b),c=default(d)",
        ...
        Function<Integer, String> generator2 =
            (count) -> String.format(
                "insert into %%s(a,e,f,g) values(%d, %d + %d,null,default) on duplicate key update e=default(e),f=default(g)",
                count, count, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
            (colA, colB, colC, colD) -> (colB == 3 || colB == 4)
                && (colC.equalsIgnoreCase("abc") || colC.equalsIgnoreCase("xyz"));
    ...
    public void singleChangeWithUpsert() throws Exception {
        ...
        QuadFunction<Integer, Integer, String, String, Boolean> checker =
            (colA, colB, colC, colD) -> (colB == 3 || colB == 4)
                && (colC.equalsIgnoreCase("abc") || colC.equalsIgnoreCase("xyz"));
        concurrentTestInternal30WithCreateTable(tableName, colDef, alterSql, selectSql, generator1, generator2, checker,
            true, createSql);
    }
    ...
    public void changeWithUpsert8() throws Exception {
        ...
        String alterSql = "alter table %s change column b e decimal(9,3)";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator1 =
            (count) -> String.format("insert into %%s(a,b,c,d) values(%d, %f,null,null) on duplicate key update a=a+%d",
                count,
                count / 7.0, FILL_COUNT);
        Function<Integer, String> generator2 =
            (count) -> String.format("insert into %%s(a,e,c,d) values(%d, %f,null,null) on duplicate key update a=a+%d",
                count,
                count / 7.0, FILL_COUNT);
        QuadFunction<Integer, Integer, String, String, Boolean> checker = (colA, colB, colC, colD) -> true;

        concurrentTestInternal30WithNotStrict(tableName, colDef, alterSql, selectSql, generator1, generator2, checker,
            true);
    }
}
