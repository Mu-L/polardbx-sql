...
public class XaStatementTraceXTest extends CrudBasedLockTestCase {
    private final static String DB_NAME = "XaStatementTraceXTest_db";
    private final static String DB2_NAME = "XaStatementTraceXTest_db2";
