...
public class PocDbleUdfWithLocality4Test extends PartitionAutoLoadSqlTestBase {

    public PocDbleUdfWithLocality4Test(AutoLoadSqlTestCaseParams parameter) {
        super(parameter);
    ...
    public static List<AutoLoadSqlTestCaseParams> parameters() {
        ...
        return getParameters(PocDbleUdfWithLocality4Test.class, 0, false);
    }
}
