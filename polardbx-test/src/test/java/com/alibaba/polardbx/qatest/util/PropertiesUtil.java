...
public class PropertiesUtil {
    ...
    public static final String POLARDBX_SERVER_ID_CONF = "&sessionVariables=polardbx_server_id=181818";
    ...
    public static boolean usePrepare() {
        return getConnectionProperties().contains("useServerPrepStmts=true") || useCursorFetch();
    }

    public static boolean useCursorFetch() {
        return getConnectionProperties().contains("useCursorFetch=true");
    }
    ...
    public static boolean useDruid = Boolean.valueOf(configProp.getProperty("useDruid", "false"));
