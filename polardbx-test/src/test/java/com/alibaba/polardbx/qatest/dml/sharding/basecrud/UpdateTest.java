...
public class UpdateTest extends CrudBasedLockTestCase {
    ...
    static {
        TABLE_FIRST_COLUMN_NOT_NUMERIC +=
            " dbpartition by hash(`node_id`) tbpartition by hash(`node_id`) tbpartitions 8\n";
    }
...
//		String[] interval_expr = {"INTERVAL MICROSECOND", "SECOND",  "MINUTE", "HOUR" };
    ...
    public void updateWithReferConditionAndSchema() {
        final String qualifiedTable = String.join(".", polardbXShardingDBName1(), baseOneTableName);
