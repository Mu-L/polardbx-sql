...
@NotThreadSafe
public class AlterTableMergePartitionTest extends AlterTableReorgBaseTest {
    final static String logicalDatabase = "AlterTableMergePartition";
    ...
    static String reorgCommand = "alter table " + tableName + " merge partitions p2,p3 to p23";

    static String reorgCommandForList = "alter table " + tableName + " merge partitions p2,p4 to p24";
    ...
    * */
    ...
    public AlterTableMergePartitionTest(PartitionRuleInfo curPartitionRuleInfo) {
