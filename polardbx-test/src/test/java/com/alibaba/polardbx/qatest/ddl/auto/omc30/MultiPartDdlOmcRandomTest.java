...
public class MultiPartDdlOmcRandomTest extends DDLBaseNewDBTestCase {

    final static Log log = LogFactory.getLog(MultiPartDdlOmcRandomTest.class);
    private String tableName = "";
    private static final String createOption = " if not exists ";

    public MultiPartDdlOmcRandomTest(boolean crossSchema) {
...
//                    Thread.sleep(smallDelay * 1000L);
                    ...
                    if (!executeSuccessOnMySQL) {
                        ...
                        String polarxErrMsg = "";
                        try {
                            JdbcUtil.executeUpdateWithException(connection, alterTableDdl + ",algorithm=omc");
                        } catch (SQLException sqlException) {
