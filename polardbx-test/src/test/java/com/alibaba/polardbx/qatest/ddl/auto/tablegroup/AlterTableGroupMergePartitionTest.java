...
@NotThreadSafe
public class AlterTableGroupMergePartitionTest extends AlterTableGroupTestBase {
    final static String logicalDatabase = "AlterTableGroupMergePartition";
    ...
    static String reorgCommand = "alter tablegroup " + tableGroupName + " merge partitions p2,p3 to p23";

    static String reorgCommandForList = "alter tablegroup " + tableGroupName + " merge partitions p2,p4 to p24";
    ...
    * */
    ...
    public AlterTableGroupMergePartitionTest(PartitionRuleInfo curPartitionRuleInfo) {
