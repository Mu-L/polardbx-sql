 ...
 */
public class TtlOmc30RebuildPolicyTest extends PartitionAutoLoadSqlTestBase {

    public TtlOmc30RebuildPolicyTest(AutoLoadSqlTestCaseParams parameter) {
        super(parameter);
    }

    @Parameterized.Parameters(name = "{index}: SubTestCase {0}")
    public static List<AutoLoadSqlTestCaseParams> parameters() {
        return getParameters(TtlOmc30RebuildPolicyTest.class, 0, false);
    }
}
