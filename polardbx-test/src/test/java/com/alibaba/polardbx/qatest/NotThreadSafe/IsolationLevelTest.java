...
public class IsolationLevelTest extends CrudBasedLockTestCase {
    ...
    public void testIsolationLevelRepeatableRead() throws Exception {
        ...
        try (Connection conn1 = getPolardbxConnection();
            Connection conn2 = getPolardbxConnection()) {
            JdbcUtil.executeUpdateSuccess(conn1, "set transaction_isolation = 'repeatable_read'");
            conn1.setAutoCommit(false);
        ...
        try (Connection conn1 = getPolardbxConnection();
            Connection conn2 = getPolardbxConnection()) {
            JdbcUtil.executeUpdateSuccess(conn1, "set transaction_isolation = 'repeatable-read'");
            conn1.setAutoCommit(false);
        ...
        try (Connection conn1 = getPolardbxConnection();
            Connection conn2 = getPolardbxConnection()) {
            JdbcUtil.executeUpdateSuccess(conn1, "set global transaction_isolation = 'repeatable_read'");
            conn1.setAutoCommit(false);
    ...
    public void testIsolationLevelReadCommitted() throws Exception {
        ...
        JdbcUtil.executeUpdateSuccess(tddlConnection, "update " + baseOneTableName + " set integer_test = 1");
        try (Connection conn1 = getPolardbxConnection();
            Connection conn2 = getPolardbxConnection()) {
            JdbcUtil.executeUpdateSuccess(conn1, "set transaction_isolation = 'read_committed'");
            conn1.setAutoCommit(false);
        ...
        try (Connection conn1 = getPolardbxConnection();
            Connection conn2 = getPolardbxConnection()) {
            JdbcUtil.executeUpdateSuccess(conn1, "set transaction_isolation = 'read-committed'");
            conn1.setAutoCommit(false);
        ...
        try (Connection conn1 = getPolardbxConnection();
            Connection conn2 = getPolardbxConnection()) {
            JdbcUtil.executeUpdateSuccess(conn1, "set global transaction_isolation = 'read-committed'");
            conn1.setAutoCommit(false);
