    ...
    static List<PartitionRuleInfo> partitionRuleInfos = new ArrayList<>(Arrays
        .asList(
            new PartitionRuleInfo(PartitionStrategy.KEY,
                ...
                "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 1, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.KEY,
                2,
                PARTITION_BY_INT_KEY, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 2, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.KEY,
                2,
                PARTITION_BY_INT_BIGINT_KEY, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 3, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.HASH,
                2,
                PARTITION_BY_INT_BIGINT_HASH, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 3, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.HASH,
                3,
                PARTITION_BY_MONTH_HASH, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 4, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.RANGE,
                1,
                PARTITION_BY_BIGINT_RANGE, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 5, 10, "p2", 100040, 100080, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.RANGE_COLUMNS,
                2,
                PARTITION_BY_INT_BIGINT_RANGE_COL, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 6, 10, "p2", 10, 20, 100040, 100080),
            new PartitionRuleInfo(PartitionStrategy.LIST,
                1,
                PARTITION_BY_BIGINT_LIST, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 7, 10, "p2", 100010, 100020, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.LIST_COLUMNS,
                4,
                PARTITION_BY_INT_BIGINT_LIST, "alter tablegroup " + tableGroupName + " move partitions p2 to ",
                true, 6, 10, "p2", 1, 1, 100010, 100020),
            new PartitionRuleInfo(PartitionStrategy.KEY,
                1,
                SINGLE_TABLE, "alter tablegroup " + tableGroupName + " move partitions p1 to ",
    ...
    public static List<PartitionRuleInfo[]> prepareData() {
        ...
        tableStatus.forEach(c -> {
            partitionRuleInfos.forEach(o -> {
                ...
                pi.setTableStatus(c);
                pi.setPhysicalTableBackfillParallel(false);
