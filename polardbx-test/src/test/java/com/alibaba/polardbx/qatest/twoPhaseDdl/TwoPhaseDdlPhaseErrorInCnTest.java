...
public class TwoPhaseDdlPhaseErrorInCnTest extends DDLBaseNewDBTestCase {

    final static Log log = LogFactory.getLog(TwoPhaseDdlPhaseErrorInCnTest.class);
    private String tableName = "";
    private static final String createOption = " if not exists ";

    public TwoPhaseDdlPhaseErrorInCnTest(boolean crossSchema) {
