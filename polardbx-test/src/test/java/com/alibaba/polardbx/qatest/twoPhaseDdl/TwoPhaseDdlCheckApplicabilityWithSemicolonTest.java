...
public class TwoPhaseDdlCheckApplicabilityWithSemicolonTest extends DDLBaseNewDBTestCase {

    final static Log log = LogFactory.getLog(TwoPhaseDdlCheckApplicabilityWithSemicolonTest.class);
    private String tableName = "";
    private static final String createOption = " if not exists ";

    public TwoPhaseDdlCheckApplicabilityWithSemicolonTest(boolean crossSchema) {
