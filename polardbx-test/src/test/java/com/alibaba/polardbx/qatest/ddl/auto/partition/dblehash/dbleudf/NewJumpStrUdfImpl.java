...
public class NewJumpStrUdfImpl extends UserDefinedJavaFunction {

    private DblePartitionAlgorithm routeFunc;

    public NewJumpStrUdfImpl() {
    }

    public NewJumpStrUdfImpl(int count, String hashSlice) {
    ...
    private void init(int count, String hashSlice) {
        NewPartitionByJumpConsistentHash newPartitionByJumpConsistentHash = new NewPartitionByJumpConsistentHash();
        newPartitionByJumpConsistentHash.setPartitionCount(count);
        newPartitionByJumpConsistentHash.setHashSlice(hashSlice);
        newPartitionByJumpConsistentHash.init();
        routeFunc = newPartitionByJumpConsistentHash;
    }

    public static class NewPartitionByJumpConsistentHash extends DblePartitionAlgorithm implements RuleAlgorithm {

        private static final long UNSIGNED_MASK = 0x7fffffffffffffffL;
        private static final long JUMP = 1L << 31;
        // If JDK >= 1.8, just use Long.parseUnsignedLong("2862933555777941757") instead.
        private final long CONSTANT = Long.parseLong("286293355577794175", 10) * 10 + 7;
        ...
        public int jumpConsistentHash(final long key, final int buckets) {
        ...
        private void checkBuckets(final int buckets) {
            if (buckets < 0) {
        ...
        public boolean equals(Object o) {
            ...
            NewPartitionByJumpConsistentHash other = (NewPartitionByJumpConsistentHash) o;
