...
@NotThreadSafe
public class AlterTableSplitPartitionTest extends AlterTableReorgBaseTest {
    ...
    * */
    static List<PartitionRuleInfo> partitionRuleInfos = new ArrayList<>(Arrays
        .asList(
            new PartitionRuleInfo(PartitionStrategy.KEY,
                ...
                "alter table " + tableName + " split partition p2",
                true, 1, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.KEY,
                2,
                PARTITION_BY_INT_KEY, "alter table " + tableName + " split partition p2",
                true, 2, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.KEY,
                2,
                PARTITION_BY_INT_BIGINT_KEY, "alter table " + tableName + " split partition p2",
                true, 3, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.HASH,
                2,
                PARTITION_BY_INT_BIGINT_HASH, "alter table " + tableName + " split partition p2",
                true, 3, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.HASH,
                3,
                PARTITION_BY_MONTH_HASH, "alter table " + tableName + " split partition p2",
                true, 4, 10, "p2", 0, 0, 0, 0),
            new PartitionRuleInfo(PartitionStrategy.RANGE,
                1,
                PARTITION_BY_BIGINT_RANGE, "alter table " + tableName
            ...
            new PartitionRuleInfo(PartitionStrategy.RANGE_COLUMNS,
                2,
                PARTITION_BY_INT_BIGINT_RANGE_COL, "alter table " + tableName
            ...
            new PartitionRuleInfo(PartitionStrategy.LIST,
                1,
                PARTITION_BY_BIGINT_LIST, "alter table " + tableName
            ...
            new PartitionRuleInfo(PartitionStrategy.LIST_COLUMNS,
                4,
                PARTITION_BY_INT_BIGINT_LIST, "alter table " + tableName
    ...
    public AlterTableSplitPartitionTest(PartitionRuleInfo curPartitionRuleInfo) {
