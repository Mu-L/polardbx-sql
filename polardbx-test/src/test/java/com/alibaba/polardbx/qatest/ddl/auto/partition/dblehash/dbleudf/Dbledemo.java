...
public class Dbledemo extends UserDefinedJavaFunction {

    protected Myhasher myhasher;
    protected static class Myhasher {
        protected int seed = 0;

        public Myhasher(int seed) {
            this.seed = seed;
        }
