...
public class TwoPhaseDdlPhaseErrorInDnTest extends DDLBaseNewDBTestCase {

    final static Log log = LogFactory.getLog(TwoPhaseDdlPhaseErrorInDnTest.class);
    private String tableName = "";
    private static final String createOption = " if not exists ";

    public TwoPhaseDdlPhaseErrorInDnTest(boolean crossSchema) {
    ...
    @Before
    public void init() {
        this.schemaPrefix = "pause_error_in_dn_";
