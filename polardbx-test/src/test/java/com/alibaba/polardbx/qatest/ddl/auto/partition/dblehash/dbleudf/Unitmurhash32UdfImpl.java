...
public class Unitmurhash32UdfImpl extends UserDefinedJavaFunction {
    ...
    public static class PartitionByUintMurmurHash extends DblePartitionAlgorithm {
        ...
        public Integer calculate(String columnValue) {
            try {
                ...
                throw new IllegalArgumentException("columnValue:" + columnValue + " Please check routeKey is legal.", e);
            }
        }
        ...
        public void selfCheck() {
            if (this.partitionCount == null || this.partitionCount.length() < 1 || Integer.valueOf(this.partitionCount) == 0) {
    ...
    public Unitmurhash32UdfImpl() {
        init("32");
    }

    protected void init(String count) {
        //MyPartitionByUintMurmurHash unitMurmurHash = new MyPartitionByUintMurmurHash();
        //unitMurmurHash.setPartitionCount(count);
        //unitMurmurHash.init();
        //routeFunc = unitMurmurHash;
    }
