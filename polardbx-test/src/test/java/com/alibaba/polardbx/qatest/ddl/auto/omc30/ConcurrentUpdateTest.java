...
public class ConcurrentUpdateTest extends Omc30DmlBaseTest {
    ...
    public void modifyWithUpdate1() throws Exception {
        ...
        ConcurrentDMLBaseTest.QuadFunction<Integer, Integer, String, String, Boolean>
            checker = (colA, colB, colC, colD) -> colA + 1 == colB;
    ...
    public void modifyWithUpdate5() throws Exception {
        ...
        ConcurrentDMLBaseTest.QuadFunction<Integer, Integer, String, String, Boolean>
            checker = (colA, colB, colC, colD) -> colB == colA + 1;
        concurrentTestInternal30(tableName, colDef, alterSql, selectSql, generator, generator, checker, true);
    }
    ...
    public void modifyWithUpdate6() throws Exception {
        ...
        ConcurrentDMLBaseTest.QuadFunction<Integer, Integer, String, String, Boolean>
            checker = (colA, colB, colC, colD) -> colB == colA + 2;
        concurrentTestInternal30(tableName, colDef, alterSql, selectSql, generator, generator, checker, true);
    }
    ...
    public void modifyMultiWithUpdate1() throws Exception {
        ...
        String colDef = "int";
        String alterSql = "alter table %s modify column b bigint, modify column c text";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator =
    ...
    public void modifyMultiWithUpdate2() throws Exception {
        ...
        String colDef = "int default 3";
        String alterSql =
            "alter table %s modify column b bigint default 4, modify column d varchar(10) not null default 'abcdefg' after c";
        String selectSql = "select * from %s order by a";
        Function<Integer, String> generator = (count) -> String.format("update %%s set b=a+1 where a=%d", count);
        ConcurrentDMLBaseTest.QuadFunction<Integer, Integer, String, String, Boolean> checker =
    ...
    public void changeWithUpdate1() throws Exception {
        ...
        ConcurrentDMLBaseTest.QuadFunction<Integer, Integer, String, String, Boolean>
            checker = (colA, colB, colC, colD) -> colA + 1 == colB;
        concurrentTestInternal30(tableName, colDef, alterSql, selectSql, generator1, generator2, checker, true);
    }
