...
public class GsiDmlTest extends DDLBaseNewDBTestCase {
    ...
    public void testRelocateImplicitCast() {
        ...
        final String createTable = MessageFormat.format("CREATE TABLE `{0}` (\n"
                ...
                + ") ENGINE = InnoDB AUTO_INCREMENT = 10235175 DEFAULT CHARSET = utf8mb4 COLLATE utf8mb4_general_ci dbpartition by hash(`account_id`) tbpartition by hash(`account_id`) tbpartitions 2;\n",
            TABLE_NAME, GSI_NAME);
