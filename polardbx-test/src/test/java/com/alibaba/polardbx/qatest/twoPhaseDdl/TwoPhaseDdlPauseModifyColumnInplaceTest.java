...
public class TwoPhaseDdlPauseModifyColumnInplaceTest extends DDLBaseNewDBTestCase {
    ...
    public TwoPhaseDdlPauseModifyColumnInplaceTest(boolean crossSchema) {
    ...
    @Before
    public void init() {
        this.schemaPrefix = "modify_column_inplace_";
