 ...
 * @author chenghui.lch
 */
public class PartitionDbleUdfTest extends PartitionTestBase {

    protected static final Log log = LogFactory.getLog(PartitionDbleUdfTest.class);
