...
public class OMCMultiWriteTest extends DDLBaseNewDBTestCase {
    final String hint1 =
        " /*+TDDL:CMD_EXTRA(ENABLE_OMC_30=false,FORCE_USING_OMC=true,GSI_FINAL_STATUS_DEBUG=DELETE_ONLY,REPARTITION_SKIP_CUTOVER=true,REPARTITION_SKIP_CLEANUP=true) */";

    final String hint2 =
        " /*+TDDL:CMD_EXTRA(ENABLE_OMC_30=false,FORCE_USING_OMC=true,GSI_FINAL_STATUS_DEBUG=WRITE_ONLY,REPARTITION_SKIP_CUTOVER=true,REPARTITION_SKIP_CLEANUP=true) */";
