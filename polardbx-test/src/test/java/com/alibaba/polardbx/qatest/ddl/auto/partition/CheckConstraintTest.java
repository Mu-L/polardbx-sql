...
@BinlogIgnore(ignoreReason = "下游是mysql时，约束条件无法正常同步，暂时忽略")
public class CheckConstraintTest extends PartitionAutoLoadSqlTestBase {
    public CheckConstraintTest(AutoLoadSqlTestCaseParams parameter) {
        super(parameter);
    }

    @Parameterized.Parameters(name = "{index}: SubTestCase {0}")
    public static List<AutoLoadSqlTestCaseParams> parameters() {
        return getParameters(CheckConstraintTest.class, 4, true);
    }
