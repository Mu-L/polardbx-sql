...
import com.alibaba.polardbx.qatest.ddl.auto.partition.dblehash.dbleudf.NewPartLongUdfImpl;
import org.junit.Assert;
import org.junit.Rule;
import org.junit.Test;
import org.junit.rules.ExpectedException;

public class PartNewLongUdfImplTest {
    ...
    public void testCalculate1() {
        NewPartLongUdfImpl
            rule = new NewPartLongUdfImpl("2", "512");
        String value = "0";
    ...
    public void testCalculate2() {
        NewPartLongUdfImpl
            rule = new NewPartLongUdfImpl("2", "1");
        String value = "0";
        Assert.assertEquals(true, 0 == doCompute(rule, value));
        value = "1";
        Assert.assertEquals(true, 1 == doCompute(rule, value));
    ...
    public void testCalculate3() {
        NewPartLongUdfImpl
            rule = new NewPartLongUdfImpl("3", "1");
        String value = "0";
        Assert.assertEquals(true, 0 == doCompute(rule, value));
        value = "1";
        Assert.assertEquals(true, 1 == doCompute(rule, value));
...
//        rule.init();
        NewPartLongUdfImpl rule = new NewPartLongUdfImpl("1,2", "1,2");
        String value = "0";
        Assert.assertEquals(true, 0 == doCompute(rule, value));
        value = "1";
        Assert.assertEquals(true, 1 == doCompute(rule, value));
...
//        rule.init();
        NewPartLongUdfImpl rule = new NewPartLongUdfImpl("3", "1");
...
//        rule.setPartitionLength("1");
//        rule.init();
        NewPartLongUdfImpl rule = new NewPartLongUdfImpl("-2", "1");
//        doCompute(rule, value);
...
//        rule.init();
        ...
        thrown.expect(RuntimeException.class);
        NewPartLongUdfImpl rule = new NewPartLongUdfImpl("0", "1");
...
//        rule.init();
        ...
        NewPartLongUdfImpl rule = new NewPartLongUdfImpl("1,-2", "1,4");
...
//        rule.setPartitionLength("360");
        NewPartLongUdfImpl
            rule = new NewPartLongUdfImpl("8", "360");
        String value = "0";
        Assert.assertEquals(true, 0 == doCompute(rule, value));
        value = "359";
        Assert.assertEquals(true, 0 == doCompute(rule, value));
