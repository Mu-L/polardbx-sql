...
public class DbInfoAccessor extends AbstractAccessor {
    ...
    public static final String QUERY_EXISTS_USER_DB = "select count(0) from " + DB_INFO_TABLE
    ...
    public int deleteDbInfoByDbName(String dbName) {
        try {
            ...
            if (DdlMetaLogUtil.isDdlTable(GmsSystemTables.DB_INFO)) {
                DdlMetaLogUtil.logSql(DELETE_DB_INFO_BY_DB_NAME, params);
            }
    ...
    public int updateDbStatusByDbName(String dbName, int dbStatus) {
        try {
            ...
            if (DdlMetaLogUtil.isDdlTable(GmsSystemTables.DB_INFO)) {
                DdlMetaLogUtil.logSql(UPDATE_DB_STATUS_BY_DB_NAME, params);
            }
...
//            DdlMetaLogUtil.logSql(SELECT_DB_INFO_BY_DB_NAME_FOR_UPDATE, params);
    ...
    public DbInfoRecord getDbInfoByDbName(String dbName) {
        try {
            ...
            MetaDbUtil.setParameter(1, params, ParameterMethod.setString, dbName);
            if (DdlMetaLogUtil.isDdlTable(GmsSystemTables.DB_INFO)) {
//                DdlMetaLogUtil.logSql(SELECT_DB_INFO_BY_DB_NAME, params);
            }
    ...
    public List<DbInfoRecord> getDbInfoByType(int dbType) {
        try {
            ...
            if (DdlMetaLogUtil.isDdlTable(GmsSystemTables.DB_INFO)) {
                DdlMetaLogUtil.logSql(SELECT_DB_INFO_BY_TYPE, params);
            }
    ...
    public List<DbInfoRecord> getDbInfoBySchAndType(String schemaName, int dbType) {
        try {
            ...
            if (DdlMetaLogUtil.isDdlTable(GmsSystemTables.DB_INFO)) {
                DdlMetaLogUtil.logSql(SELECT_DB_INFO_BY_DB_TYPE, params);
            }
    ...
    public void addNewDb(String dbName,
        ...
        try {
            if (DdlMetaLogUtil.isDdlTable(GmsSystemTables.DB_INFO)) {
                DdlMetaLogUtil.logSql(INSERT_IGNORE_NEW_DB_WITH_EXTRA, params);
            }
    ...
    public void updateDbReadWriteStatusByName(String dbName, int readWriteStatus) {
        ...
        try {
            if (DdlMetaLogUtil.isDdlTable(GmsSystemTables.DB_INFO)) {
                DdlMetaLogUtil.logSql(UPDATE_DB_READ_WRITE_STATUS_BY_DB_NAME, params);
            }
