 ...
 */
@ToString
public class CclBlockerRecord implements SystemTableRecord {
    ...
    @Override
    public CclBlockerRecord fill(ResultSet rs) throws SQLException {
    ...
    public Map<Integer, ParameterContext> buildParams() {
        ...
        MetaDbUtil.setParameter(++index, params, ParameterMethod.setString, this.user);
        MetaDbUtil.setParameter(++index, params, ParameterMethod.setString, this.host);
