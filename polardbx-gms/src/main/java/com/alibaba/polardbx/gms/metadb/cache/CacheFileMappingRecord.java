...
public class CacheFileMappingRecord implements SystemTableRecord {
    public long id;
    ...
    @Override
    public CacheFileMappingRecord fill(ResultSet rs) throws SQLException {
