 ...
 */
public class DrdsDropCclBlockerTest extends MysqlTest {

    @Test
    public void testDropCclBlocker1() {
        String sql = "DROP CCL_BLOCKER `busu`";
    ...
    @Test
    public void testDropCclBlocker2() {
        String sql = "DROP CCL_BLOCKER ";
        MySqlStatementParser parser = newParser(sql);
