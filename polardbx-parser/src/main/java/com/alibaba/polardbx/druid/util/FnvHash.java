...
public final class FnvHash {
    ...
    public static interface Constants {
        ...
        long NTILE = fnv1a_64_lower("NTILE");
        long NTH_VALUE = fnv1a_64_lower("NTH_VALUE");
        ...
        long RESULT = fnv1a_64_lower("RESULT");
        ...
        // more mysql character sets.
        long _DEC8 = fnv1a_64_lower("_DEC8");
        long _CP850 = fnv1a_64_lower("_CP850");
        long _HP8 = fnv1a_64_lower("_HP8");
        long _KOI8R = fnv1a_64_lower("_KOI8R");
        long _LATIN2 = fnv1a_64_lower("_LATIN2");
        long _SWE7 = fnv1a_64_lower("_SWE7");
        long _ASCII = fnv1a_64_lower("_ASCII");
        long _SJIS = fnv1a_64_lower("_SJIS");
        long _HEBREW = fnv1a_64_lower("_HEBREW");
        long _TIS620 = fnv1a_64_lower("_TIS620");
        long _EUCKR = fnv1a_64_lower("_EUCKR");
        long _KOI8U = fnv1a_64_lower("_KOI8U");
        long _GB2312 = fnv1a_64_lower("_GB2312");
        long _GREEK = fnv1a_64_lower("_GREEK");
        long _CP1250 = fnv1a_64_lower("_CP1250");
        long _LATIN5 = fnv1a_64_lower("_LATIN5");
        long _ARMSCII8 = fnv1a_64_lower("_ARMSCII8");
        long _CP866 = fnv1a_64_lower("_CP866");
        long _KEYBCS2 = fnv1a_64_lower("_KEYBCS2");
        long _MACCE = fnv1a_64_lower("_MACCE");
        long _MACROMAN = fnv1a_64_lower("_MACROMAN");
        long _CP852 = fnv1a_64_lower("_CP852");
        long _LATIN7 = fnv1a_64_lower("_LATIN7");
        long _CP1251 = fnv1a_64_lower("_CP1251");
        long _CP1256 = fnv1a_64_lower("_CP1256");
        long _CP1257 = fnv1a_64_lower("_CP1257");
        long _BINARY = fnv1a_64_lower("_BINARY");
        long _GEOSTD8 = fnv1a_64_lower("_GEOSTD8");
        ...
        Set<Long> MYSQL_CHARACTER_SETS = ImmutableSet.of(
            ...
            _EUCKR, _KOI8U, _GB2312, _GREEK, _CP1250, _GBK, _LATIN5, _ARMSCII8, _UTF8, _UCS2, _CP866, _KEYBCS2,
            _MACCE, _MACROMAN, _CP852, _LATIN7, _UTF8MB4, _CP1251, _UTF16, _UTF16LE, _CP1256, _CP1257, _UTF32,
            _BINARY, _GEOSTD8, _CP932, _EUCJPMS, _GB18030
        );
