...
public class SQLPartitionByUdfHash extends SQLPartitionBy {
    ...
    public SQLPartitionByUdfHash clone() {
        SQLPartitionByUdfHash x = new SQLPartitionByUdfHash();
        cloneTo(x);
    ...
    public void cloneTo(SQLPartitionByUdfHash x) {
        super.cloneTo(x);
