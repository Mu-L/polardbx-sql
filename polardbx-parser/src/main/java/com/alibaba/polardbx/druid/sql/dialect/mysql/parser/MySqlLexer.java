...
import com.alibaba.polardbx.druid.sql.parser.CharTypes;
import com.alibaba.polardbx.druid.sql.parser.Keywords;
import com.alibaba.polardbx.druid.sql.parser.Lexer;
import com.alibaba.polardbx.druid.sql.parser.NotAllowCommentException;
            ...
            while (true) {
                ...
                if (isVersionHint && ch == '/' && charAt(starIndex + 1) == '*') {
                    ...
                    if (ch == '!') {
                        ...
                        // Normal comment or optimizer hint, so scan to end.
                        while (true) {
