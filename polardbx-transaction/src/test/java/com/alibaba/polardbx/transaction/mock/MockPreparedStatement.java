...
/**
 * Mock PreparedStatement implementation for testing purposes.
 */
public class MockPreparedStatement extends MockStatement implements PreparedStatement {
    ...
    public MockPreparedStatement(MockConnection connection, String sql, MockDatasource mockDatasource) {
        super(connection, mockDatasource);
        this.sql = sql;
        this.parameters = new Object[100]; // Assume max 100 parameters
    }
