...
/**
 * Mock ResultSet implementation for testing purposes.
 */
public class MockResultSet implements ResultSet {
    ...
    public MockResultSet(MockStatement statement, MockResultSetData resultData) {
        this.statement = statement;
        this.columnNames = resultData.getColumnNames();
        this.rows = resultData.getRows();
    }
    ...
    // Update methods - not supported in read-only result set
    @Override
    ...
    private Object getValue(int columnIndex) throws SQLException {
        ...
        Object[] currentRow = rows.get(currentRowIndex);
        Object value = currentRow[columnIndex - 1]; // JDBC columns are 1-based
        wasNull = (value == null);
        return value;
    }
    ...
    /**
     * Simple mock ResultSetMetaData implementation.
     */
