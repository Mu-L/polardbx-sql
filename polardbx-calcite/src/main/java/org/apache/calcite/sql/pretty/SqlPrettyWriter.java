...
public class SqlPrettyWriter implements SqlWriter {
  ...
  private final Deque<FrameTypeEnum> optStack = new ArrayDeque<>();
   ...
   *                     the default
   */
  public void describe(StringWriter sw, boolean omitDefaults) {
  ...
  public FrameTypeEnum popOptStack() {
    return optStack.pop();
  }

  public FrameTypeEnum peekOptStack() {
    return optStack.peek();
  }

  public void pushOptStack(FrameTypeEnum frame) {
    optStack.push(frame);
  }
