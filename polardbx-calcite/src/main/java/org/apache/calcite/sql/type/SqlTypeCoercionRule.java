...
public class SqlTypeCoercionRule implements SqlTypeMappingRule {
  ...
  static {
    ...
    coerceRules.add(SqlTypeName.TINYINT_UNSIGNED, rule);
    coerceRules.add(SqlTypeName.SMALLINT, rule);
    coerceRules.add(SqlTypeName.SMALLINT_UNSIGNED, rule);
    coerceRules.add(SqlTypeName.MEDIUMINT, rule);
    coerceRules.add(SqlTypeName.MEDIUMINT_UNSIGNED, rule);
    coerceRules.add(SqlTypeName.INTEGER, rule);
    coerceRules.add(SqlTypeName.INTEGER_UNSIGNED, rule);
    coerceRules.add(SqlTypeName.SIGNED, rule);
    coerceRules.add(SqlTypeName.UNSIGNED, rule);
    coerceRules.add(SqlTypeName.BIGINT, rule);
    coerceRules.add(SqlTypeName.BIGINT_UNSIGNED, rule);
    ...
    coerceRules.add(SqlTypeName.TIME, rule);
    coerceRules.add(SqlTypeName.TIME_WITH_LOCAL_TIME_ZONE, rule);
    coerceRules.add(SqlTypeName.DATE, rule);
    coerceRules.add(SqlTypeName.DATETIME, rule);
    ...
    // BLOB is castable from VARCHAR, CHAR, BOOLEAN, DATE, TIME, TIMESTAMP, numeric types, binary and
    // intervals
    coerceRules.add(SqlTypeName.BLOB,
        coerceRules.copyValues(SqlTypeName.BLOB)
            .add(SqlTypeName.CHAR)
            .add(SqlTypeName.VARCHAR)
            .add(SqlTypeName.BOOLEAN)
            .add(SqlTypeName.DATE)
