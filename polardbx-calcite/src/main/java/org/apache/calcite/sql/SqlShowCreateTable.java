...
public class SqlShowCreateTable extends SqlShow {
    ...
    public SqlKind getShowKind() {
        return SqlKind.SHOW_CREATE_TABLE;
    }

    public static class SqlShowCreateTableOperator extends SqlSpecialOperator {

        public SqlShowCreateTableOperator() {
            super("SHOW_CREATE_TABLE", SqlKind.SHOW_CREATE_TABLE);
        }
        ...
        public RelDataType deriveType(SqlValidator validator, SqlValidatorScope scope, SqlCall call) {
            ...
            columns.add(new RelDataTypeFieldImpl("Create Table", 1, typeFactory.createSqlType(SqlTypeName.VARCHAR)));
