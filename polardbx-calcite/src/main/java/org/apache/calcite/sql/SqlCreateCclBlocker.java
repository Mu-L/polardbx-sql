 ...
 */
public class SqlCreateCclBlocker extends SqlDal {
    private static final SqlSpecialOperator OPERATOR = new SqlCreateCclBlockerOperator();

    private SqlIdentifier blockerName;

    private SqlIdentifier schemaName;

    private SqlIdentifier user;
    private SqlIdentifier host;
    ...
    public SqlCreateCclBlocker(SqlParserPos pos) {
        super(pos);
    }
    ...
    public SqlKind getKind() {
        return SqlKind.CREATE_CCL_BLOCKER;
    }
    ...
    public void unparse(SqlWriter writer, int leftPrec, int rightPrec) {
        ...
        writer.sep("CREATE CCL_BLOCKER");
        if (ifNotExits) {
            writer.sep("IF NOT EXISTS");
        }
        blockerName.unparse(writer, leftPrec, rightPrec);
    ...
    public static class SqlCreateCclBlockerOperator extends SqlSpecialOperator {
        public SqlCreateCclBlockerOperator() {
            super("CREATE_CCL_BLOCKER", SqlKind.CREATE_CCL_BLOCKER);
        }
        ...
        public RelDataType deriveType(SqlValidator validator, SqlValidatorScope scope, SqlCall call) {
            ...
            return typeFactory
                .createStructType(
                    ImmutableList.of((RelDataTypeField) new RelDataTypeFieldImpl("Create_Ccl_Blocker_Result",
                        0,
                        columnType)));
        }
    ...
    public SqlIdentifier getBlockerName() {
        return blockerName;
    }

    public void setBlockerName(SqlIdentifier blockerName) {
    ...
    public void setUser(SqlIdentifier user) {
        this.user = user;
    }

    public SqlIdentifier getUser() {
        return this.user;
    }

    public void setHost(SqlIdentifier host) {
        this.host = host;
    }

    public SqlIdentifier getHost() {
        return this.host;
    }
}
