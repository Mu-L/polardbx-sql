...
public interface CalciteResource {
    ...
    @BaseMessage("")
    ExInstWithCause<CalciteContextException> validatorContextPoint(int a0, int a1);

    @BaseMessage("")
    ExInstWithCause<CalciteContextException> validatorContext(int a0, int a1, int a2, int a3);
    ...
    @BaseMessage("Unknown table ''{0}'' in MULTI DELETE")
    ExInst<SqlValidatorException> unknownTableInMultiDelete(String a0);
    ...
    ExInst<CalciteException> invalidCompare(String a0, String a1, String a2, String a3);
    ...
    @BaseMessage("Type ''{0}'' is not supported for cast/convert function")
    ExInst<SqlValidatorException> typeNotSupportedForCast(String a0);
    ...
    @BaseMessage("Group Concat Ordinal out of range")
    ExInst<SqlValidatorException> groupConcatOrderByOrdinalOutOfRange();
    ...
    ExInst<CalciteException> illegalArgumentForTableFunctionCall(String a0, String a1, String a2);
    ...
    // If CREATE TABLE does not have "AS query", a type must be specified for
    // each
    // column
    ...
    @BaseMessage("Duplicate index name ''{0}''")
    ExInst<SqlValidatorException> duplicateIndexName(String name);

    @BaseMessage("Duplicate column name ''{0}'' in index ''{1}''")
    ExInst<SqlValidatorException> duplicateGsiColumnName(String columnName, String indexName);

    @BaseMessage("Find the duplicate relation name ''{0}'' in FROM clause. Please use `AS` to rename the relation ''{0}'' ")
    ExInst<SqlValidatorException> fromAliasDuplicateWithTips(String a0);
