...
public abstract class Correlate extends BiRel {
  ...
  public SemiJoinType getJoinType() {
    ...
    protected RelDataType deriveRowType() {
        ...
        case ANTI:
        case SEMI:
            return SqlValidatorUtil.createApplyBooleanType(getCluster().getTypeFactory(), left.getRowType());
        default:
            throw new IllegalStateException("Unknown semi join type " + joinType);
        }
    }
