...
//        : "trivial sort";
  ...
  public final Sort copy(RelTraitSet traitSet, RelNode newInput) {
    return copy(traitSet, newInput, collation, offset, fetch);
  }
