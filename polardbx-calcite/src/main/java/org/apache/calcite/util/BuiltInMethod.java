...
import org.apache.calcite.rel.metadata.BuiltInMetadata.ColumnOriginName;
...
public enum BuiltInMethod {
  ...
  WORKER_COUNT(Parallelism.class, "workerCount"),
  MEMORY(Memory.class, "memory"),
  LOWER_BOUND_COST(BuiltInMetadata.LowerBoundCost.class, "getLowerBoundCost",
  ...
  COLUMN_ORIGIN_NAME(ColumnOriginName.class, "getColumnOriginNames"),
  ORIGINAL_ROW_TYPE(BuiltInMetadata.OriginalRowType.class, "getOriginalRowType"),
  DML_COLUMN_NAME(BuiltInMetadata.DmlColumnName.class, "getDmlColumnNames"),
  COVERING_INDEX(CoveringIndex.class, "isCoveringIndex", RelOptTable.class, String.class),
  EXPRESSION_LINEAGE(ExpressionLineage.class, "getExpressionLineage", RexNode.class),
  TABLE_REFERENCES(TableReferences.class, "getTableReferences", boolean.class),
  CUMULATIVE_COST(CumulativeCost.class, "getCumulativeCost"),
  NON_CUMULATIVE_COST(NonCumulativeCost.class, "getNonCumulativeCost"),
  START_UP_COST(BuiltInMetadata.StartUpCost.class, "getStartUpCost"),
  ...
  FUNCTIONAL_DEPENDENCY(BuiltInMetadata.FunctionalDependency.class, "getFunctionalDependency", ImmutableBitSet.class),
