 ...
 */
public class MemoryCountableInt2ObjectArrayMap<V> extends AbstractInt2ObjectMap<V>
    implements java.io.Serializable, Cloneable, MemoryCountable {

    private static final int INSTANCE_SIZE =
        ClassLayout.parseClass(MemoryCountableInt2ObjectArrayMap.class).instanceSize();
    private static final int ENTRY_SET_INSTANCE_SIZE =
        ClassLayout.parseClass(MemoryCountableInt2ObjectArrayMap.EntrySet.class).instanceSize();
    private static final int KEY_SET_INSTANCE_SIZE =
        ClassLayout.parseClass(MemoryCountableInt2ObjectArrayMap.KeySet.class).instanceSize();
    private static final int VALUE_COLLECTION_INSTANCE_SIZE =
        ClassLayout.parseClass(MemoryCountableInt2ObjectArrayMap.ValuesCollection.class).instanceSize();

    private static final long serialVersionUID = 1L;

    @FieldMemoryCounter(value = false)
    private final MemoryCounter<V> vMemoryCounter;
     ...
     */
    public MemoryCountableInt2ObjectArrayMap(MemoryCounter<V> vMemoryCounter, final int[] key, final Object[] value) {
     ...
     */
    public MemoryCountableInt2ObjectArrayMap(MemoryCounter<V> vMemoryCounter) {
        this.vMemoryCounter = vMemoryCounter;
     ...
     */
    public MemoryCountableInt2ObjectArrayMap(MemoryCounter<V> vMemoryCounter, final int capacity) {
        this.vMemoryCounter = vMemoryCounter;
     ...
     * @param m a map.
     */
    public MemoryCountableInt2ObjectArrayMap(final Int2ObjectMap<V> m, MemoryCounter<V> vMemoryCounter) {
        this(vMemoryCounter, m.size());
        int i = 0;
     ...
     * @param m a map.
     */
    public MemoryCountableInt2ObjectArrayMap(final Map<? extends Integer, ? extends V> m,
                                             MemoryCounter<V> vMemoryCounter) {
        this(vMemoryCounter, m.size());
        int i = 0;
    ...
    private final class EntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            return MemoryCountableInt2ObjectArrayMap.this.containsKey(k) && java.util.Objects.equals(
                MemoryCountableInt2ObjectArrayMap.this.get(k), (e.getValue()));
        }
        ...
        public boolean remove(final Object o) {
            ...
            final int oldPos = MemoryCountableInt2ObjectArrayMap.this.findKey(k);
            if (oldPos == -1 || !java.util.Objects.equals(v, MemoryCountableInt2ObjectArrayMap.this.value[oldPos])) {
                return false;
            }
            final int tail = size - oldPos - 1;
            System.arraycopy(MemoryCountableInt2ObjectArrayMap.this.key, oldPos + 1,
                MemoryCountableInt2ObjectArrayMap.this.key, oldPos, tail);
            System.arraycopy(MemoryCountableInt2ObjectArrayMap.this.value, oldPos + 1,
                MemoryCountableInt2ObjectArrayMap.this.value, oldPos, tail);
            MemoryCountableInt2ObjectArrayMap.this.size--;
            MemoryCountableInt2ObjectArrayMap.this.value[size] = null;
            return true;
        }
    }
    ...
    public void clear() {
        for (int i = size; i-- != 0; ) {
            valueMemoryUsage -= vMemoryCounter.getMemoryUsage((V) value[i]);
            value[i] = null;
        }
        size = 0;
    }
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        @Override
        public void clear() {
            MemoryCountableInt2ObjectArrayMap.this.clear();
        }
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public MemoryCountableInt2ObjectArrayMap<V> clone() {
        MemoryCountableInt2ObjectArrayMap<V> c;
        try {
            c = (MemoryCountableInt2ObjectArrayMap<V>) super.clone();
