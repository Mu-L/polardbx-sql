...
public interface ORCMetaReader extends Closeable {
    ...
    static ORCMetaReader create(Configuration configuration, FileSystem fileSystem) {
        return new ORCMetaReaderImpl(configuration, fileSystem, null);
    }

    static ORCMetaReader create(Configuration configuration, FileSystem fileSystem, Integer sortKeyColumn) {
        return new ORCMetaReaderImpl(configuration, fileSystem, Collections.singleton(sortKeyColumn));
    }

    static ORCMetaReader create(Configuration configuration, FileSystem fileSystem, Set<Integer> sortKeyColumns) {
        return new ORCMetaReaderImpl(configuration, fileSystem, sortKeyColumns);
    }
