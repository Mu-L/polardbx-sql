...
public class TrxLogTableConstants {
    ...
    public static final String ALTER_GLOBAL_TX_TABLE_COMMIT_TS =
        TddlConstants.RDS_INTERNAL_MARK +
    ...
    public static final String ALTER_REDO_LOG_TABLE =
        TddlConstants.RDS_INTERNAL_MARK
            + "ALTER TABLE `" + REDO_LOG_TABLE + "` "
    ...
    public static final String SELECT_MAX_TX_ID_IN_ARCHIVE =
        TddlConstants.RDS_INTERNAL_MARK + "SELECT max(TXID) FROM " + SystemTables.POLARDBX_GLOBAL_TX_LOG_TABLE_ARCHIVE;

    /**
     * Drop archive table if it is not needed any more.
     */
    public static final String DROP_GLOBAL_TX_TABLE_V2_ARCHIVE =
        TddlConstants.RDS_INTERNAL_MARK + "DROP TABLE IF EXISTS " + SystemTables.POLARDBX_GLOBAL_TX_LOG_TABLE_ARCHIVE;
    ...
    public static final String SELECT_BY_ID_V2 =
        TddlConstants.RDS_INTERNAL_MARK
            + "SELECT `TRX_SEQ`, `N_PARTICIPANTS` FROM " + SystemTables.POLARDBX_GLOBAL_TX_LOG_TABLE
            + " WHERE `TXID` = %s";
