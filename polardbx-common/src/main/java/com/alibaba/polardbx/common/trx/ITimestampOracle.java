...
public interface ITimestampOracle extends Lifecycle {
    ...
    AtomicReference<ITimestampOracle> INSTANCE = new AtomicReference<>(null);
    ...
    static void setInstance(ITimestampOracle instance) {
        INSTANCE.set(instance);
    }

    static ITimestampOracle getInstance() {
        return INSTANCE.get();
    }
}
